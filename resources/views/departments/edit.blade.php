                    ...
                    <form action="{{ route('departments.update', $department->id_department) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="code" id="code" class="mt-1 block w-full px-10 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-200" value="{{ old('code', $department->code) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="description" id="description" class="mt-1 block w-full px-10 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-200" value="{{ old('description', $department->description) }}" required>
                            </div>
                        </div>
