        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex items-center">
                    ...
                    <!-- Master Data Dropdown (untuk semua user) -->
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute mt-2 w-48 rounded-md shadow-lg z-10">
                            <div class="rounded-md bg-white shadow-xs">
                                <x-dropdown-link :href="route('stock-in.index')">
                                    {{ __('Stock In') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('stock-out.index')">
                                    {{ __('Stock Out') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('stock-transfer.index')">
                                    {{ __('Stock Transfer') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('stock-conversion.index')">
                                    {{ __('Stock Conversion') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('adjustment.index')">
                                    {{ __('Adjustment') }}
                                </x-dropdown-link>
                            </div>
                        </div>
                    ...
                    @if(Auth::user()->hasRole('super-admin'))
                        <!-- Register User Link khusus untuk super-admin -->
